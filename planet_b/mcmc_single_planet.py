...
def lnlike(theta):
	...
	like1 = -0.5*(np.sum((f1-light_c5)**2/sigma2c5))
	like2 = -0.5*(np.sum((f2 - light_c18)**2 / sigma2c18))
	like3 = -0.5*(np.sum((f3 - light_c18_high_cad)**2 / sigma2c18highcad))
...
ndim = 5 + 2
nwalkers = 100
p0 = [2457152.2844,15.572,15,88,0.02] + \
	 [0.3,0.3]
